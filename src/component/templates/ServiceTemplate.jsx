function ServiceTemplate({ img, title, uses }) {
  return (
    <div className="w-[100%]  relative  shadow-lg  sm:h-[27vh] md:h-[37vh]  flex flex-col  items-center p-4 sm:w-[30%] bg-[#fffff9] rounded-[12px] ">
      ...
      <p className="text-justify text-[10px] sm:text-[13px] font-[300]">
        {uses}
      </p>
    </div>
  );
